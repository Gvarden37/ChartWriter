...
const
  ...
  { Property name constants, used with the TCWFileReader }
  C_Chart = 'Chart';
  C_Graph = 'Graph';
  C_Title = 'Title';
  ...
  C_SectionLabelMargin = 'SectionLabelMargin';
  C_SectionLineColor = 'SectionLineColor';
...
type
  ...
  public
    ...
    property Val: single read GetVal write FVal;
  ...
  TMouseItemEvent = procedure(Sender: TObject; SeriesIndex, ItemIndex: integer)
    of object;
  TActivateGraphEvent = procedure(Sender: TObject; var DataNeeded: Boolean)
    of object;
  ...
  private
    FWriter: TChartWriter;
    FOnActivateGraph: TActivateGraphEvent;
    FGDIP: TGPGraphics;
  ...
  public
    ...
    function InChart(DataIndex : integer = -1) : Boolean;
  ...
  published
    ...
    property OnActivateGraph: TActivateGraphEvent read FOnActivateGraph
      write FOnActivateGraph;
  end;

  TGraphList = TList<TCWGraph>;
  ...
  public
    ...
    function IndexOf(const ASeriesName: string): integer;
  ...
  private
    ...
    procedure SetSeriesID(Value: string);
  protected
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
    function IndexOf(const ASeriesID: string): integer;
    procedure SetColor(const ASeriesID: string; AColor: TColor);
    function GetColor(const ASeriesID: string): TColor;
    procedure DeleteColor(const ASeriesID: string);
  ...
  private
    ...
    procedure DrawTheLine(ASource : TSeries; Indx: integer; x1, y1, x2, y2: integer);
  public
  ...
  private
    ...
    procedure GetCathesus(var HorzCath, VertCath: integer);
    procedure DoDraw;
  ...
  public
    ...
    procedure AssignGraph(Source: TCWGraph); override;
    procedure Draw; override;
    function GetBarSpace(var BlockWidth: integer;
  ...
  published
    ...
    property BarStyle: TBarStyle read GetBarStyle write SetBarStyle
      default bsFlat;
    property ScrollingBarWidth: integer read FScrollingBarWidth
      write SetScrollingBarWidth default 20;
    property ColorUsage: TColorUsage read FColorUsage write SetColorUsage
      default cuOnSeries;
    property TextQualifier: string read FTextQualifier write FTextQualifier;
  ...
  private
    ...
    procedure SetDonutSize(Value: integer);
  ...
  published
    ...
    property DonutSize: integer read FDonutSize write SetDonutSize default 0;
  ...
  published
    ...
    property CaptionLayout: TCaptionLayout read FCaptionLayout
      write SetCaptionLayout default clSameSideAsLabels;
  ...
  private
    ...
    function GetOwnerData: TCWChart;
    property Canvas: TCanvas read GetCanvas;
    property InsideGraph: Boolean read GetInsideGraph;
  protected
  public
    property OwnerData: TCWChart read GetOwnerData;
    property Writer: TChartWriter read GetWriter;
  ...
  private
    ...
    FPieRect: TRect;
    FDoNutRect: TRect;
    FUseItemColors: Boolean;
    FLineStyle: TCurvelineStyle;
    FLineWidth: integer;
    FCurveStyle: TCurveStyle;
    FIndent, FExdent: integer;
    FContraction: integer; { Not used, only assignments }
  ...
  public
    ...
    property DonutRect: TRect read FDoNutRect;
  ...
  TCWValueSpan = class(TPersistent)
  private
  ...
  published
    ...
    property NumSpanPrecision: integer read FNumSpanPrecision
  ...
  private
    ...
    FValueAxis1 : TCWValueSpan;
    FValueAxis2 : TCWValueSpan;
    FLegends : TCWLegends;
  ...
  protected
    ...
    property OverflowAction : TOverflowAction read FOverFlowAction write SetOverflowAction default ovContraction;
    property ValueSectionDefs : TCWValueSectionDefs read FValueSectionDefs write SetValueSectionDefs;
    property ValueAxis1 : TCWValueSpan read FValueAxis1 write FValueAxis1;
    property ValueAxis2 : TCWValueSpan read FValueAxis2 write FValueAxis1;
  ...
  private
    ...
    procedure WMDOACTIVATE(var Msg: Tmessage); message WM_DOACTIVATE;
    procedure PostHist;
  ...
  public
    ...
    procedure SaveToFile(AFileName: TFileName; DataOnly: Boolean = False);
    ...
    procedure GetValueSpan(ASeries: TSeries;
      var HighVal, LowVal: single); overload;
    ...
    procedure HideRuler;
    function SeriesOfName(AName: string): TSeries;
    procedure SetValueSpan(LowValue, HighValue: single);
    ...
    property Count: integer read GetCount;
    property GraphList: TGraphList read FGraphList;
  ...
  published
    ...
    property TextTilting: TTextOrientations read FTextTilting
      write SetTextTilting default [];
    property TextTiltThreshold: integer read FTextTiltThreshold
      write SetTextTiltThreshold default 1;
...
function FormatNum(ANumber: single; Precision: integer): string;
...
const
  ...
  ErrorMsg: array [0 .. MsgCnt - 1] of string = (
    ...
    { 61 } 'Graph assigment requires Writer to be set',
    ...
    { 69 } 'Value must be in the range of 10..70%',
...
begin
  Result := FDataContent[SeriesIndex].Count - 2;
end;
...
var
  S: string;
begin
  S := FDataContent[SeriesIndex].ValueFromIndex[ItemIndex + 2];
  Result := 0;
...
begin
  Result := FDataContent[SeriesIndex].KeyNames[ItemIndex + 2];
end;
...
begin
  ...
  begin
    ...
    SerDest.FSeriesName := Writer.FSeriesData[i].FSeriesName;
...
begin
  ...
  begin
    ...
    SerDest.FSeriesName := Series[i].FSeriesName;
...
begin
  ...
  begin
    ...
    if QW > W then  {Draw vertically}
      Result := Result + Writer.GetTextHeight(lk) + c_QualifierMargin;
  end
  else
  begin
    ...
    if QW > W then
      Result := Result + H + c_QualifierMargin;
  end;
end;
...
function TCWValueSpan.GetWriter : TChartWriter;
begin
  Result := FOwner.Writer;
end;

procedure TCWValueSpan.Assign(Source : TPersistent);
begin
  if Source is TCWValueSpan then
  begin
    FNumSpanPrecision := TCWValueSpan(Source).NumSpanPrecision;
    FValueIntervals := TCWValueSpan(Source).ValueIntervals;
    FValueHigh := TCWValueSpan(Source).ValueHigh;
    FValueLow := TCWValueSpan(Source).ValueLow;
    FValueSpanFromData := TCWValueSpan(Source).ValueSpanFromData;
    FValuePrecision := TCWValueSpan(Source).ValuePrecision;
  end
  else
    inherited Assign(Source)
end;

function TCWValueSpan.GetValueFloatUnit: single;
begin
...
function TCWValueSpan.GetValueCount: integer;
{ Counts the number og whole YUnits }
begin
  Result := floor((ValueHigh - ValueLow + 1) / FValueIntervals);
end;

procedure TCWValueSpan.SetNumSpanPrecision(Value: integer);
begin
...
procedure TCWValueSpan.SetValueSpanFromData(Value: Boolean);
begin
...
procedure TCWValueSpan.SetValueHigh(Value: single);
var
  ErrNumber: single;
  Insp: Boolean;
begin
...
procedure TCWValueSpan.SetValueLow(Value: single);
var
  ErrNumber: single;
  Insp: Boolean;
begin
...
procedure TCWValueSpan.SetValueIntervals(Value: single);
begin
...
procedure TCWValueSpan.SetValuePrecision(Value: integer);
begin
...
procedure TCWValueSpan.SetHighLow;
begin
  if not FOwner.IsActive then
    Exit;
  if Fowner.SeriesCount = 0 then
    Exit;
  Writer.GetValueSpan(FValueHigh, FValueLow);
end;

procedure TCWValueSpan.SetValueSpan(LowValue, HighValue: single);
var
  ErrNumber: single;
  Insp: Boolean;
begin
...
procedure TCWValueSpan.SetQualifier(Value : string);
begin
  Value := Trim(Value);
...
begin
  ...
  FValueAxis1 := TCWValueSpan.Create;
  FNameType := ntGeneral;
  with FValueAxis1 do
  begin
    FValueHigh := 1;
  ...
  FValueAxis2 := TCWValueSpan.Create;
  with FValueAxis2 do
  begin
    FValueHigh := 1;
    FValueLow := 0;
...
function TCWChart.GetSeriesCount : integer;
begin
   Result := 0;
   if FSeriesData <> nil then
  ...
  begin
    ...
    begin
      if AxisOrientation <> alBottomLeft then
        ShowMessage
          ('Note that walls can only be shown when name / value axis Orientation is bottom / left')
      else if Writer.GraphBorders = gbNone then
        ShowMessage
          ('Note that walls cannot be shown when there are no graph borders defined');
    end;
    Writer.RefreshGraph;
  end;
end;
...
begin
  ...
  if (SeriesDefs.Count > 0) and (SeriesDefs[0].Graph is TCWPie) and (Value <> ntGeneral) then
    ShowGWError(-1, 'Pies require the ntGeneral name type');
  FNameType := Value;
...
begin
  ...
  if FWriter <> nil then
  begin
    FSeriesData := Writer.FSeriesData;
...
begin
  ...
  begin
    try
      FNameSectionDefs.FOwnerData := Self;
...
begin
  ...
  begin
     if (TCWBar(Self).Layout = blSideBySide) and (Value = ovCompression) then
      ShowGWError(-1, 'Cannot use compression when layout is side by side');
  end;
...
begin
  ...
  for i := 0 to Legends.Count - 1 do
    ...
    begin
      Legends.Items[i].FLegend.FOwnerData := self;
...
var
 ...
 function GetRect(Ax : TCWValueSpan) : TRect;
 var
   GR : TRect;
   AxObj : TAxisobject;
 ...
 begin
     ...
     begin
       ...
       begin
          Result.Top := GR.Top;
          Result.Bottom := GR.Top + Writer.FGraphMargins.Top;
          if AxObj.Position = apLeft then
          begin
            Result.Right := GR.Left;
            Result.Left := Result.Right - AxObj.LabelSpace;
          end
          else
          begin
            Result.Left := GR.Right;
            Result.Right := Result.Left + AxObj.LabelSpace;
          end;
       end
       else
       begin
         ...
         if AxObj.Position = apLeft then
         begin
           Result.Right := GR.Left - Writer.GetTextWidth(lkValue) - c_QualifierMargin;
           Result.Left := AxObj.LabelRect.Left;
         end
         else
         begin
           Result.Left := GR.Right + Writer.GetTextWidth(lkValue) + c_QualifierMargin;;
     ...
     begin
       ...
       begin
          Result.Left := GR.Left;
          Result.Right := GR.Left + Writer.FGraphMargins.Left;
          if AxObj.Position = apTop then
          begin
            Result.Top := GR.Top;
            Result.Bottom := Result.Top - AxObj.LabelSpace;
          end
          else
          begin
            Result.Top := GR.Bottom;
            Result.Bottom := Result.Top + AxObj.LabelSpace;
          end;
       end
       else
       begin
         ...
         if AxObj.Position = apTop then
         begin
           Result.Bottom := GR.Top - Writer.GetTextHeight(lkValue) - c_QualifierMargin;;
           Result.Top := AxObj.LabelRect.Top;
         end
         else
         begin
           Result.Top := GR.Bottom + Writer.GetTextHeight(lkValue) + c_QualifierMargin;;
...
function TCWChart.GetSeries(Index : integer) : TSeries;
begin
...
begin
  for I := 0 to SeriesCount-1 do
    FSeriesDefs.Items[i].FGraph := NewGraph;
  Writer.RefreshGraph;
end;
...
function TCWGraph.InChart(DataIndex: Integer = -1) : Boolean;
var
  i : integer;
begin
  Result := false;
  ...
  if DataIndex = -1 then
  begin
    for I := 0 to Writer.Chart.FSeriesDefs.Count-1 do
    begin
      Result := Writer.Chart.FSeriesDefs.Items[i].Graph = Self;
      if Result then
        Break;
    end;
  end
  ...
  begin
   if (DataIndex > Writer.Chart.SeriesCount-1) or (DataIndex < 0)  then
     Exit;
   Result := Writer.Chart.FSeriesDefs.Items[DataIndex].Graph = Self;
  end;
end;
...
begin
  ...
  if (Writer <> nil) and (Writer.Chart <> nil) then
    Result := Writer.Chart.Series[Value];
end;
...
procedure TCWGraph.SetWriter(Value: TChartWriter);
var
   i : integer;
begin
  if Value = FWriter then
  ...
  if Value = nil then
  begin
    Writer.GraphList.Delete(Writer.GraphList.IndexOf(Self));
    FWriter := nil;
  end
  else
  begin
  {Pies first, bars next, curves last}
    FWriter := Value;
    if Writer.GraphList.Count = 0 then
     Writer.GraphList.Add(Self)
    else if Self is TCWPie then
     Writer.GraphList.Insert(0, Self)
    else if Self is TCWCurve then
     Writer.GraphList.Add(Self)
    else
    begin
      for I := 0 to Writer.GraphList.Count-1 do
        begin
          if (Writer.GraphList[i] is TCWBar) or (Writer.GraphList[i] is TCWCurve) then
          begin
           Writer.GraphList.Insert(i, Self);
           Break;
          end;
        end;
    end;
...
procedure TCWSeriesStyle.SetSeriesID(Value: string);
var
  i: integer;
begin
  if Trim(Value) = '' then
  ...
  begin
    if i <> Index then
    begin
      if SameText(Value, TCWSeriesStyles(Collection).Items[i].FSeriesID) then
...
function TCWSeriesStyles.IndexOf(const ASeriesName: string): integer;
var
  i: integer;
begin
  Result := -1;
  if Trim(ASeriesName) = '' then
    Exit;
  for i := 0 to Count - 1 do
  begin
    if SameText(ASeriesName, Items[i].SeriesID) then
    begin
      Result := i;
      Break;
    end;
...
begin
  ...
  if Trim(ASeries.SeriesName) = '' then
  begin
  ...
  for i := 0 to Count - 1 do
  begin
    if SameText(ASeries.SeriesName, Items[i].SeriesID) then
    begin
      Result := Items[i];
      Break;
    end;
...
function TCWColors.IndexOf(const ASeriesID: string): integer;
var
  i: integer;
begin
  Result := -1;
  if Trim(ASeriesID) = '' then
    Exit;
  for i := 0 to Count - 1 do
  begin
    if SameText(ASeriesID, Items[i].ItemName) then
    begin
      Result := i;
      Break;
    end;
...
function TCWColors.GetColor(const ASeriesID: string): TColor;
var
  Indx: integer;
begin
  Result := clBlack;
  Indx := IndexOf(ASeriesID);
  if Indx <> -1 then
    Result := Items[Indx].Color;
end;

procedure TCWColors.SetColor(const ASeriesID: string; AColor: TColor);
var
  Indx: integer;
  c: TCWColor;
begin
...
procedure TCWColors.DeleteColor(const ASeriesID: string);
var
  Indx: integer;
begin
  Indx := IndexOf(ASeriesID);
...
begin
  ...
  if (LineWidth = Value) or (Value < 1) or (Value > 3) then
    Exit;
  FLineWidth := Value;
  if Writer <> nil then
    Writer.DoRepaint;
...
begin
  ...
  if (ASeries = nil) then
    Exit;
  begin
    if ASeries.FSeriesName <> '' then
    begin
      Result := SeriesStyles.IndexOf(ASeries.FSeriesName);
    end
    else
    begin
...
procedure TCWCurve.DrawTheLine(ASource : TSeries; Indx: integer; x1, y1, x2, y2: integer);
var
   Clr: TColor;
   Styl: integer;
...
var
  ...
  var
    ...
    begin
      ...
      if (PointMarkers <> pmNone) and (ActiveStyle[ASource] = csLine) then
      begin
        ...
        begin
          S := FormatNum(ASource.FSeriesItems[AIndex].Val,
    ...
    begin
      ...
      begin
        ...
        if not DoLineEvent(ltRegression, -1, FOnDrawStatLine, pStart, PEnd) then
          DrawTheLine(ASource, -1, pStart.X, pStart.Y, PEnd.X, PEnd.Y);
      end;
    end;
...
begin
  ...
  loop := 0;
  LoopCnt := Writer.Chart.SeriesCount - 1;
  if Writer.InState(stAnimating) then
  begin
    Anim := True;
  ...
  begin
    ...
    begin
      ...
      if Writer.Chart.FSeriesDefs.Items[i].Graph <> nil then
        if (Writer.Chart.Series[i].Visible) and (Writer.Chart.FSeriesDefs.Items[i].Graph = Self) then
        begin
          DoDraw(Series[i]);
        end;
      ...
      begin
        ...
        if (i = Writer.Chart.SeriesCount - 1) then
...
begin
  ...
  begin
    ...
    if not((Writer.Chart.Series[i].Visible) and HasNeighborPoly
     and (Writer.Chart.Series[i].Graph = Self))
    then
    begin
      inc(i);
      inc(Indx);
      if i > Writer.Chart.SeriesCount - 2 then
        Break
      else
        Continue;
    end;
...
begin
  if (FBarStyle = bsFlat) or (Writer = nil) or
  ...
  begin
    ...
    if Result and (FBarStyle = bsCube) then
      Result := (CubeAngle > 0)
  end;
end;
...
begin
  ...
  if (Writer.Chart.FOverflowAction = ovCompression) and (Value = blSideBySide)
   then
    ShowGWError(-1, 'Cannot use side by side layout when overflow action is compression');
  ...
  if (Writer = nil) or (Writer.Chart = nil) then
    Exit;
  if Writer.Chart.SeriesCount = 0 then
    Exit;
  if not(csLoading in componentState)
  then
  begin
...
begin
  ...
  if (BWidth <> 0) then
  begin
    if (Layout = blSideBySide) and (Writer.Chart.SeriesCount > 1) then
    begin
      Result := (BWidth * Writer.Chart.SeriesCount) + ItemSpacing +
        (SeriesSpacing * (Writer.Chart.SeriesCount - 1));
    end
    else
      Result := BWidth + ItemSpacing; // + 1;
  end
...
var
  Cpr: Boolean;
begin
  if GetBarSpace(Result, Cpr) then
    Result := 0;
end;
...
procedure TCWBar.GetCathesus(var HorzCath, VertCath: integer);
var
  a: extended;
  A2: extended;
  D: integer;
  ...
  begin
    ...
    begin
      ...
      begin
       ...
       Result := Writer.Chart.Series[SeriesIndex].SeriesItems[ItemIndex].Color;
    end
    else
    begin
      S := Writer.Chart.Series[SeriesIndex].SeriesItems[ItemIndex].FName;
...
var
  ...
  begin
    ...
    if TextQualifier = '' then
      ...
      S := TextQualifier;
    V := Writer.SeriesItems[SerInd, ItmIndex].Val;
    S := FormatNum(V, Writer.ValuePrecision) + S;
    ...
    begin
      ...
      begin
        ...
        begin
          if (ARect.Bottom - H - Marg < ARect.Top) then
          begin
            Y := ARect.Bottom + Marg;
            Canvas.Font.Color := InvertColor(Writer.GraphBGColor);
          end
          else
            Y := ARect.Bottom - H - Marg;
        end;
        if (Y > Gr.Top) and (Y < Gr.Bottom) then
          Canvas.TextOut(X, Y, S);
      end;
    end
    else
    begin
      if H < ARect.Height then
      begin
        Y := ARect.CenterPoint.Y - H div 2;
        if not(boBaseLine in Options) or
          ((boBaseLine in Options) and (V >= BaseLineValue)) then
        begin
          if ARect.Right - W - Marg > ARect.Left then
            X := ARect.Right - W - Marg
          else
          begin
            X := ARect.Right + Marg;
            Canvas.Font.Color := InvertColor(Writer.GraphBGColor);
        ...
        begin
          if ARect.Left + W + Marg > ARect.Right then
          begin
            X := ARect.Left - W - Marg;
            Canvas.Font.Color := InvertColor(Writer.GraphBGColor);
          end
        ...
        if (X > Gr.Left) and (X < Gr.Right) then
        begin
          Canvas.TextOut(X, Y, S);
        end;
      end;
  ...
  begin
    ...
    Dec(R.Right);
    Clr := ChangeColor(Color, d3_TopCylinder);
    SetTheColor(Clr, 2);
    ...
    GradBrush := TGPLinearGradientBrush.Create(MakePoint(R.Left, 10),
      MakePoint(R.Right, 10), GPClr2, GPClr1);
  ...
  procedure DrawCube(ABarRect: TRect; Color: TColor; FirstBar: Boolean;
    SerIndx: integer);
  var
    TopL, TopR, BotR, BotL: TPoint;
    Clr: TColor;
  ...
  begin
    ...
    if (boOutLines in Options) and FirstBar then
    begin
  ...
  begin
    ...
    begin
      ...
      DrawBarText(BarRect, SerInd, ItmNumber);
    end;
  end;
  ...
  begin
    Result := False;
    Posits.Clear;
    for i := 0 to Writer.Chart.SeriesCount - 1 do
    begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if R.Top = GRect.Top then
          inc(R.Top);
        if R.Top = GRect.Bottom then
          Dec(R.Top);
        ...
        if (Layout = blSideBySide) and (Writer.VisibleCount > 1) and
          (Writer.Chart.SeriesCount > 1) and not Compressing then
        begin
        ...
        begin
          ...
          begin
            ...
            DrawBarText(R, Posits[i].SerInd, ItmNumber);
          end;
        end;
        ...
        begin
         ClrIndx := ItmNumber;
         if ClrIndx >= Writer.Chart.ItemColors.Count-1 then
         begin
           Writer.FSeriesData[Posits[i].SerInd].FSeriesItems[ClrIndx].FColor := SelColor;
         end
         else
          Writer.Chart.ItemColors.Items[ClrIndx].FColor := SelColor;
        end
        else
        begin
         ClrIndx := Posits[i].SerInd;
         Writer.Chart.FseriesDefs.Items[ClrIndx].FColor := SelColor;
        end;
...
var
  ...
  BlockSize: single;
  BlockCount: integer;
  BarWidth: integer; { Same name as ChartWriter.BarWidth but local }
  OutLineMin: integer;
  RegularMin: integer;
...
const
  ...
  begin
      Result := Writer.Chart.SeriesCount;
  end;
...
procedure TCWPie.SetDonutSize(Value: integer);
begin
  if Value = FDonutSize then
    Exit;
  if (Value <> 0) then
  begin
    if not Value in [10 .. 70] then
      ShowGWError(msg_DonutRange);
  end;
  FDonutSize := Value;
  if Writer <> nil then
    Writer.DoRepaint;
...
const
  ...
  var
    ...
    begin
      ...
      begin
        ...
        Ang := DegToRad(Angle);
        if FDonutSize > 0 then
        begin
          Factor := 2 - 1 / 100 * (FDonutSize + 10);
    ...
    var
      ...
      procedure DrawDoNut(PieRect: TRect);
      var
        wd, L, T: integer;
      begin
        wd := round(PieRect.Width * FDonutSize / 100);
        ...
        ASource.FDoNutRect := Rect(L, T, wd, wd);
      end;
  ...
  begin
    ...
    X := R.CenterPoint.X - Writer.GetTextWidth(lkName, S) div 2;
    Y := R.Top + 5;
    Canvas.Brush.Style := bsClear;
    Canvas.TextOut(X, Y, S);
  end;
...
begin
  ...
  if Chart.Writer = nil then
    ShowGWError(msg_NoWriter);
  if (Value is TCWPie) and (Chart.NameType <> ntGeneral) then
    ShowGWError(-1, 'Pies require the ntGeneral name type');
  if (Chart is TCWAxisChart) and (Value is TCWPie) then
    Exit
  else if (Chart is TCWPieChart) and (Value is TCWAxisGraph) then
    Exit;
...
begin
  ...
  (*if (TCWChart(Owner).Writer = nil) or
  (csLoading in TCWChart(Owner).ComponentState)
  ...
  if (csDesigning in TCWChart(Owner).ComponentState)
  and (Action in [cnExtracting, cnAdded]) then
  begin
    if Action = cnExtracting then
       TCWChart(Owner).Writer.RenderDesigner(1)
    else
      TCWChart(Owner).Writer.RenderDesigner;
  end;
  inherited;*)
...
begin
  Result := nil;
  if FOwnerData = nil then
    Exit;
  Result := FOwnerData.Writer;
end;
  ...
  if Value <> nil then
    ...
    begin
      ...
      if L.Legend = Value then
        ShowGWError(-1, 'Duplicate Legend');
    end;
  FLegend := Value;
  FLegend.FOwnerData := Collection.Owner as TCWChart;
  FLegend.FWriter := FLegend.FOwnerData.Writer;
end;
  ...
  case Anchoring of
    ...
    anRightInside, anRightOutside:
      if InsideGraph then
        ...
        Result := Writer.WorkRect.Right - FOwnerData.Legends.WidestLegend(AxisPosition);
...
function TCWLegend.GetOwnerData: TCWChart;
begin
  Result := FOwnerData;
end;
...
var
  ...
  begin
    ...
    for i := 0 to Writer.Count - 1 do
    begin
      S := FormatNum(Writer.FSeriesData[i].FSeriesItems[ItmIndx].Val,
        Writer.ValuePrecision);
      if AValue = S then
      begin
        Result := i;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          S := FormatNum(Writer.FSeriesData[SerIndx].FSeriesItems[ItmIndx].Val,
            Writer.ValuePrecision);
          ValOK := S = PointValue;
        end;
      end
      ...
      begin
        ...
        begin
          if not(coName in Elems) then
            sl.Add(ClrTag + FormatNum(Writer.FSeriesData[i].FSeriesItems[j].Val,
              Writer.ValuePrecision))
          else
            sl[sl.Count - 1] := sl[sl.Count - 1] + ': ' +
              FormatNum(Writer.FSeriesData[i].FSeriesItems[j].Val,
              Writer.ValuePrecision);
        end;
        if ClrTag <> '' then
        begin
        ...
        begin
          if OwnerData.FSeriesDefs.Items[i].Graph is TCWBar then
          begin
            if TCWBar(OwnerData.FSeriesDefs.Items[i].Graph).ColorUsage = cuOnItems then
              FWidth := FWidth + W + BullWidth + BullMarg + 5
            else
              FWidth := FWidth + W + 5;
          end
          else if OwnerData.FSeriesDefs.Items[i].Graph is TCWPie then
          begin
            FWidth := FWidth + W + BullWidth + BullMarg + 5;
          end
          else
...
var
  ...
  begin
    if OwnerData.FSeriesDefs.Items[SerIndx].Graph is TCWBar then
      with OwnerData.FSeriesDefs.Items[SerIndx].Graph as TCWBar do
      begin
        if ColorUsage = cuOnSeries then
          Result := OwnerData.FSeriesDefs.Items[SerIndx].Color
        else
        begin
          Result := OwnerData.ItemColors.Items[ItemIndx].Color;
        end;
      end
    else if OwnerData.FSeriesDefs.Items[SerIndx].Graph is TCWPie then
      with OwnerData.FSeriesDefs.Items[SerIndx].Graph as TCWPie do
      begin
        Result := OwnerData.ItemColors.Items[ItemIndx].Color;
      end
    else
  ...
  begin
    ...
    SumRects := OwnerData.FSummaryRects;
    repeat
      Del := False;
      for i := 0 to Rects.Count - 1 do
      begin
  ...
  var
    ...
    begin
      Result := False;
      for i := 0 to Ownerdata.FPointRects.Count - 1 do
      begin
        R := OwnerData.FPointRects[i].R;
        if ARect.IntersectsWith(R) then
        begin
          Result := True;
          Break;
        end;
        P := OwnerData.FPointRects[i].P;
      ...
      for i := 0 to Ownerdata.FSummaryRects.Count - 1 do
      begin
        R := Ownerdata.FSummaryRects[i].R;
        if ARect.IntersectsWith(R) then
        begin
          Result := True;
          Break;
  ...
  begin
    ...
    begin
      S2 := FormatNum(Writer.FSeriesData[SerIndex].FSeriesItems[i].Val,
        Writer.ValuePrecision);
      if S2 = S then
      begin
        Result := i;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if (OwnerData.FSeriesDefs.Items[i].Graph is TCWBar) and
              (TCWBar(OwnerData.FSeriesDefs.Items[i].Graph).Layout = blSideBySide) then
            begin
...
begin
  ...
  FMax := ASource.FMax;
  FMin := ASource.FMin;
  FContraction := ASource.FContraction;
  FColor := ASource.FColor;
  FLeapdateCount := ASource.FLeapdateCount;
  FWriter := ASource.FWriter;
  FSeriesName := ASource.FSeriesName;
  FUseItemColors := ASource.FUseItemColors;
  FLineStyle := ASource.FLineStyle;
  FLineWidth := ASource.FLineWidth;
  FCurveStyle := ASource.FCurveStyle;
  FGraph := ASource.FGraph;
end;
...
begin
  ...
  try
    ...
    Ser.FSeriesItems.Sort(TComparer<TSeriesItem>.Construct(
      ...
      begin
        if a.FVal = B.FVal then
          Result := 0
        else if a.FVal > B.FVal then
          Result := 1
        else
          Result := -1;
      end));
    ...
    try
      ...
      begin
        S := FormatNum(Ser.Items[i].FVal, Writer.ValuePrecision);
        if i > 0 then
        begin
          S2 := FormatNum(Ser.Items[i - 1].FVal, Writer.ValuePrecision);
          if S = S2 then
          begin
            sl.Add(S);
          end;
...
begin
  ...
  try
    ...
    if Odd(Ser.Count) then
      Result := Ser.Items[Ser.Count div 2].FVal
    else
    begin
      i := Ser.Count div 2;
      V1 := Items[i].FVal;
...
procedure TSeries.SetSeriesName(Value: string);
begin
  if SameText(Value, FSeriesName) then
    Exit;
  FSeriesName := Value;
end;
...
begin
  ...
  for i := 0 to FSeriesItems.Count - 1 do
  begin
    S2 := FormatNum(FSeriesItems[i].FVal, Writer.ValuePrecision);
    if S = S2 then
    begin
      Result := i;
      Break;
...
procedure TChartWriter.WMDOACTIVATE(var Msg: Tmessage);
var
  Needed: Boolean;
begin
  Needed := True;
  ActiveGraph.FOnActivateGraph(ActiveGraph, Needed);
end;
...
begin
  ...
  try
    ...
    begin
      ...
      NewSer.FWriter := Self;
      NewSer.FSeriesName := Ser.FSeriesName;
      NewSer.FColor := Ser.FColor;
      NewSer.FSeriesName := Ser.FSeriesName;
      NewSer.FUseItemColors := Ser.FUseItemColors;
      NewSer.FLineStyle := Ser.FLineStyle;
      NewSer.FLineWidth := Ser.FLineWidth;
      NewSer.FCurveStyle := Ser.FCurveStyle;
      NewSer.FIndent := 0;
      NewSer.FExdent := 0;
      NewSer.FGraph := Ser.FGraph;
...
begin
  for I := 0 to Chart.SeriesDefs.Count-1 do
    begin
      ...
      begin
        ShowGWError(-1, 'Undefined Graph in Chart');
      end;
      ...
      and (Count > 1)
      then
        ShowGWError(-1, 'Side by side bar layout cannot be used with Compression oveflow action');
    end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowGWError(-1, 'Conflicting name types');
      end;
      try
    ...
    if Chart.FSeriesDefs.Count <> FSeriesData.Count then
      ShowGWError(-1, 'Number of actual and formal series must be alike');
    CheckValspans;
    ComputeTextExtent;
...
begin
  if Chart = nil then
    ...
    Found := false;
      ...
      begin
        if GraphList[i].InChart then
        begin
         J := Chart.SeriesDefs.IndexOf(GraphList[i]);
         GraphList.Delete(i);
         Chart.SeriesDefs.Items[j].Graph.Free;
         Found := True;
         Break;
        end;
      end;
...
var
  ...
  begin
    ...
    case MI of
      ...
      miValue:
        FHintText := FormatNum(SerItm.Val, Prec);
      miBoth:
        begin
          if IsTimeSpan(Chart.NameType) then
    ...
    if (G <> nil) and not(G is TCWPie) then
    begin
...
begin
  for I := 0 to Chart.SeriesCount-1 do
  begin
    if Chart.FSeriesDefs.Items[i].Graph is TCWCurve then
     TCWCurve(Chart.FSeriesDefs.Items[i].Graph).FBeaconIndex := -1;
  end;
end;
...
begin
  ...
  begin
    if FDynaSectStart <> FDynaSectEnd then
      ShowMessage
        ('Could not decide selection. Be sure to pick a real start and end point.')
    else
      ShowMessage('Nothing to zoom.');
    DoCancel;
    Exit;
  end;
...
begin
  ...
  if AComponent is TCWGraph then
  begin
    Indx := GraphList.IndexOf(AComponent as TCWGraph);
    if Indx <> -1 then
      GraphList.Delete(Indx);
  end
  else if AComponent is TCWChart then
  begin
...
begin
  ...
  begin
    ...
    NewSer.FIndent := 0;
    NewSer.FExdent := 0;
    NewSer.FContraction := Ser.FContraction;
    NewSer.FGraph := Ser.FGraph;
    ...
    begin
      ...
      begin
        FSeriesData[i].FPoints.Add(FSeriesData[i].PosFromNamVal(FSeriesData[i].FSeriesItems[j]
          .FName, FSeriesData[i].FSeriesItems[j].Val));
      end;
    end
  else
  begin
    ...
    TCWBar(ActiveGraph).GetBarSpace(Space, Cpr);
    for i := 0 to FSeriesData.Count - 1 do
    begin
      if Chart.FSeriesDefs.Items[i].ValueAxis = vaValueAxis1 then
        FActiveValAx := FValax
      ...
      repeat
        ...
        begin
          FSeriesData[i].FBarPoints.Add
            ...
            FSeriesData[i].FSeriesItems[j].Val));
...
begin
  ...
  if (Chart.OverflowAction = ovCompression) or
...
var
  ...
  var
    ...
    begin
      ...
      if (G <> nil) and (TCWCurve(G).PointMarkers <> pmNone) then
        ...
        Add := 0;
      W := GetTextWidth(lkInfo, FHintText) + 11;
  ...
  begin
    ...
    Canvas.Rectangle(R);
    Canvas.Brush.Style := bsClear;
    Canvas.TextOut(R.Left + 2, R.Top + 1, FHintText);
    ResetCanvas;
    RedrawGraphLines;
  end;
  ...
  begin
      ...
      try
        ...
        begin
          if Info.Text.Count <> HintInfo.Text.Count then
            ShowMessage('Number of text lines cannot be changed.')
          else
    ...
    begin
      ...
      begin
        S := HintInfo.Text[i];
        Canvas.Font.Color := HintInfo.Clrs[i];
        Canvas.TextOut(R.Left, R.Top + (H * i), S);
      end;
...
var
  ...
  begin
    ...
    if (Result > FTextTiltThreshold) then
    begin
      Res := Result;
...
begin
  ...
  begin
    if Values[i].Val < 0 then
    begin
      Result := -1
    end;
    Acc := Acc + Values[i].Val;
  end;
...
begin
  ...
  begin
    for i := 0 to Chart.SeriesCount - 1 do
      if (Chart.FSeriesDefs.Items[i].FGraph is AGraphType) and (i > Index)
      and Chart.FSeriesDefs.Items[i].Visible then
      begin
        Result := Chart.FSeriesDefs.Items[i].FGraph;
        inc(Index);
        Break;
      end;
  end;
...
var
  ...
  begin
    ...
    sl.DefaultEncoding := TEncoding.Utf8;
    try
      Indx := Props.IndexOf('{COLOR' + IntToStr(0) + '}');
      while Indx <> -1 do
      begin
        sl.Clear;
        for i := 1 to 2 do
        ...
        inc(Indx2);
        Indx := Props.IndexOf('{COLOR' + IntToStr(Indx2) + '}');
      end;
    finally
      sl.Free;
    end;
  ...
  procedure SetValSpans(Props: TStringList; Ax: TCWValueSpan);
  begin
    ...
    Ax.FNumSpanPrecision := StrToInt(Props.Values[C_NumSpanPrecision]);
  ...
  begin
    ...
    try
      ...
      begin
        ...
        St.FSeriesID := sl.Values[C_Ident];
...
begin
  ...
  try
    ...
    if sl.IndexOf(Props) = 0 then
    begin
      if csDesigning in ComponentState then
        ShowGWError(-1, 'Chart files cannot be loaded design time');
...
var
  ...
  begin
    S := AValue + '=0';
    if AnOption in FTextTilting then
    begin
      S := AValue + '=1';
    end;
    PropList.Add(S);
...
begin
  ...
  PropList.Add(S);
  S := C_NumSpanPrecision + '=' + IntToStr(NumSpanPrecision);
  PropList.Add(S);
  SetTiltOpt(toName, C_toName);
  SetTiltOpt(toName, C_toValue);
  S := C_TextTiltThreshold + '=' + IntToStr(FTextTiltThreshold);
  PropList.Add(S);
...
var
  ...
  procedure SetTextTiltOpt(Opt: TTextOrientation; Indx: integer);
  begin
    if Boolean(StrToInt(PropList.ValueFromIndex[Indx])) then
      FTextTilting := FTextTilting + [Opt]
    else
      FTextTilting := FTextTilting - [Opt];
  end;
...
begin
  ...
  begin
    ...
    if PropList.Names[i] = C_toName then
      SetTextTiltOpt(toName, i);

    if PropList.Names[i] = C_toValue then
      SetTextTiltOpt(toValue, i);

    if PropList.Names[i] = C_TextTiltThreshold then
      FTextTiltThreshold := StrToInt(PropList.ValueFromIndex[i]);
...
procedure TChartWriter.SaveToFile(AFileName: TFileName;
...
var
  ...
  procedure GetValSpans(Valspan: TCWValueSpan; Num : integer);
  begin
    ...
    SetKeyVal(saveSL, C_NumSpanPrecision, IntToStr(ValSpan.NumSpanPrecision));
  ...
  begin
    ...
    begin
      ...
      SetKeyVal(saveSL, C_Ident, c.SeriesStyles.Items[i].SeriesID);
...
begin
  ...
  try
    for i := 0 to FOrigData.Count - 1 do
    begin
      saveSL.Add('Title=' + FOrigData[i].Title);
      saveSL.Add('ID=' + FOrigData[i].SeriesName);
      sl := FOrigData[i].AsStrings(False);
      saveSL.AddStrings(sl);
      saveSL.Add(EOF);
      sl.Free;
...
procedure TChartWriter.AddSeries(ASeries: TSeries);
begin
...
begin
  ...
  begin
    ...
    SerItm.FWriter := Self;
    SerItm.FRealVal := SerItm.FVal;

    if SerItm.FVal > ASeries.FMax then
      ASeries.FMax := SerItm.FVal;
    if SerItm.FVal < ASeries.FMin then
      ASeries.FMin := SerItm.FVal;
    ASeries.FSum := ASeries.FSum + SerItm.FVal;
    if SerItm.FVal < 0 then
  ...
  try
    ...
    else if (Chart.NameType = ntGeneral) and not (ActiveGraph is TCWPie) then
...
procedure TChartWriter.AddSeries(Values: TStringList);
var
  i: integer;
  Crd: TSeriesItem;
  Ser: TSeries;
...
begin
  ...
  for i := 0 to Values.Count - 1 do
  begin
    if Chart.NameType = ntNumberSpan then
    begin
      if not TryStrToInt(Values.Names[i], n) then
      begin
        Ser.Free;
        ShowGWError(msg_InvalidNumber, Values.Names[i]);
      end;
    end;
    ...
    Crd.FVal := StrToFloat(Values.Values[Crd.FName], Fmt);
    Crd.FRealVal := Crd.FVal;

    if Crd.FVal > Ser.FMax then
      Ser.FMax := Crd.FVal;
    if Crd.FVal < Ser.FMin then
      Ser.FMin := Crd.FVal;
    Ser.FSum := Ser.FSum + Crd.FVal;
    if Crd.FVal < 0 then
      Ser.FNegVals := True;
...
begin
  ...
  Result.Right := GraphRect.Right + SpaceOf(apRight);
  Result.Bottom := GraphRect.Bottom + SpaceOf(apBottom);
end;
...
begin
  ...
  try
    ...
    if LabelKind = lkName then
    begin
      if not(toName in FTextTilting) then
        S := WN
      else
      begin
        if (Angle < 900) then
    ...
    begin
      if not(toValue in FTextTilting) then
        S := WV
      else
      begin
        if (Angle < 900) then
    ...
    begin
      if not(toSection in FTextTilting) then
        S := WNS
      else
      begin
        if (Angle < 900) then
...
procedure TChartWriter.SetTextTilting(Value: TTextOrientations);
begin
  ...
  if not(csLoading in componentState) then
  begin
    FUpdateKinds := FUpdateKinds + [ukLabelFreq];
    CheckLabelFreqs;
  end;
  DoRepaint;
end;

procedure TChartWriter.SetTextTiltThreshold(Value: integer);
begin
...
begin
  ...
  begin
    if FActiveValAx = FValAx then
      Chart.ValueAxis1.FNumSpanPrecision := Value
    else
      Chart.ValueAxis2.FNumSpanPrecision := Value;
  end;
end;
...
begin
  ...
  begin
    if FActiveValAx = FValAx then
      Result := Chart.ValueAxis1.NumSpanPrecision
    else
      Result := Chart.ValueAxis2.NumSpanPrecision;
  end;
end;
...
function TChartWriter.SeriesOfName(AName: string): TSeries;
var
  i: integer;
begin
  Result := nil;
  for i := 0 to Count - 1 do
    if SameText(FSeriesData[i].SeriesName, AName) then
    begin
      Result := FSeriesData[i];
      Break;
    end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Val := Ser.FSeriesItems[Ser.FirstItem + j].Val;
        Result := True;
        Exit;
      end;
    end;
...
begin
  ...
  if (ActiveGraph = nil) then
    Exit;
  if InState(stUpdating) or InState(stPainting) or (FSeriesData.Count = 0) then
    Exit;
  if ViewMode <> vmHinting then
  begin
    Invalidate;
...
begin
  ...
  try
    ...
    begin
      ...
      NewSer.FIndent := 0;
      NewSer.FExdent := 0;
      NewSer.FContraction := NewSer.FContraction + Rate - 1;
      LastE := 0;
      LastCnt := 0;
      E := 0;
      Cnt := 0;
